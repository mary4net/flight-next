        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-xl rounded-2xl p-10 mb-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-12 justify-center">
              <Link href="/flights" className="px-8 py-4 bg-blue-600 text-white rounded-xl shadow-lg hover:bg-blue-700 transition transform hover:scale-105">
                ✈️ Book a Flight
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition">
              ...
              <Link href="/flights" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium">Search flights →</Link>
            </div>
